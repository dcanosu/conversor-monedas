...
public class ConversorDeMonedas {
    ...
    public void convertirPesoArgentinoADolar() {
        try {
            URL url = new URL("https://v6.exchangeratesapi.io/latest?base=ARS&access_key=" + API_KEY);
            double tasaCambioUSD = obtenerTasaCambio(url, "USD");
            System.out.println("Convertir de peso argentino a dólar");
            // Lógica para convertir de peso argentino a dólar utilizando la tasa de cambio obtenida
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
